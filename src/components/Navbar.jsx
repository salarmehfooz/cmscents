...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Azadi Sale Announcement Bar */}
      {isAzadiSaleActive() && (
        <button
          onClick={() =>
            window.dispatchEvent(new CustomEvent("open-azadi-popup"))
          }
        ...
        >
          <span>🇵🇰</span>
          <span>
            14th August Azadi Grand Sale •{" "}
            <strong className="text-white">FLAT 40% OFF On All Products</strong>
          </span>
          <span className="hidden sm:inline text-gold-light/90">
            • CLICK FOR DETAILS
          </span>
        </button>
      )}
